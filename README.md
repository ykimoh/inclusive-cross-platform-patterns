...
Open issues and PRs welcome. For new patterns, follow the entry template documented in the contribution template. The short version: nine sections, Title, Problem, Pattern, Visual examples, Code snippet, Annotation, WCAG mapping, Related patterns, Further reading.
